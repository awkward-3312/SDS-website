document.addEventListener('DOMContentLoaded', () => {
  ...
  /* NAV MOBILE: toggle accesible y cierre (agregado) */
  (function initMobileNav() {
    const btn = document.getElementById('navToggle');
    const menu = document.getElementById('mainMenu');
    if (!btn || !menu) return;

    // Estado inicial si no definido
    ...
    const openMenu = () => {
      ...
      // bloquear scroll del documento para evitar scroll detrás del panel
    ...
    // Cerrar con clic fuera del menú cuando esté abierto
    ...
    // Si se redimensiona a desktop, cerrar el menú si está abierto
